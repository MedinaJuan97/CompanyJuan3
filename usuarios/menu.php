  ...
  <header>
    <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
      <a href="control.php" class="d-flex align-items-center text-dark text-decoration-none">
        ...
        <span class="fs-4">Agregar usuario</span>
      </a>
<?php 
...
<div class="container">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        ...
        <button value="btnAgregar" onclick="return Confirmar('¿Desea agregar?');" <?php echo $accionAgregar;?> class="btn btn-success" type="submit" name="accion">Agregar</button>
    ...
    <button type="button" class="btn btn-primary form-group col-md-2" data-toggle="modal" data-target="#exampleModal">
      Agregar registro
    </button>
    </form>
...
<!-- 
    <a href="listado.php">
      <button type="button" class="btn btn-primary form-group col-md-2">Listar datos</button>
    </a>
-->
